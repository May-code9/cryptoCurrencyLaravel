<div class="sidebar-left">
  ...
  <ul class="nav flex-column in" id="side-menu">
    ...
    <li class="nav-item"><a  href="{{ route('cryptoDashboard') }}" class="nav-link">DashBoard</a></li>
    ...
    <!-- <li class="nav-item"><a  href="javascript:void(0)" class="nav-link menudropdown">Gallery<i class="fa fa-angle-down "></i></a>
      <ul class="nav flex-column nav-second-level">
        <li class="nav-item"><a class="nav-link" href="#">View Images</a> </li>
        <li class="nav-item"><a class="nav-link" href="#">Upload Images</a> </li>
      </ul>
    </li> -->
