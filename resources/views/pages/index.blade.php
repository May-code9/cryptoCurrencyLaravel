                          ...
                          <div class="sppb-column-addons">
                            ...
                            <div id="section-id-1515846769886" class="sppb-section "  >
                              <div class="sppb-container-inner">
                                <div class="sppb-row">
                                  <div class="sppb-col-md-4">
                                    <div id="column-id-1515846769887" class="sppb-column" >
                                      <div class="sppb-column-addons">
                                        <div id="sppb-addon-1515846769935" class="clearfix" >
                                          <div class="sppb-addon sppb-addon-text-block 0 sppb-text-left ">
                                            <div class="sppb-addon-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus et ipsum eget tortor consequat faucibus. Quisque aliquet nisl vel ante blandit, et convallis neque lobortis. Donec in gravida tellus, in suscipit eros. Cras scelerisque bibendum posuere.</div>
                                          </div>
                                        </div>
                                        <div id="sppb-addon-1515846769948" class="clearfix" >
                                          <div class="sppb-empty-space  clearfix"></div>
                                        </div>
                                        <div id="sppb-addon-1515846769958" class="clearfix" >
                                          <div class="sppb-addon sppb-addon-raw-html ">
                                            <div class="sppb-addon-content">
                                              <script type="text/javascript">
                                              crypt_multi_num_cur = "6";
                                              crypt_base_cur_0 = "Bitcoin (BTC)";crypt_target_cur_0 = "US Dollar (USD)";crypt_base_cur_1 = "Bitcoin (BTC)";crypt_target_cur_1 = "Euro (EUR)";crypt_base_cur_2 = "Bitcoin (BTC)";crypt_target_cur_2 = "RUP (RUP)";crypt_base_cur_3 = "Bitcoin (BTC)";crypt_target_cur_3 = "XIN (XIN)";crypt_base_cur_4 = "Bitcoin (BTC)";crypt_target_cur_4 = "NBIT (NBIT)";crypt_base_cur_5 = "Bitcoin (BTC)";crypt_target_cur_5 = "ZMC (ZMC)";crypt_multi_background_color = "#ffb426";crypt_multi_border_width = 0;crypt_multi_font_color = "#fff";crypt_multi_display_time = false;
                                              </script>
                                            ...
                                            <div class="sppb-addon-content">
                                              <div class="sppb-media">
                                                ...
                                                <div class="sppb-media-body">
                                                  <h3 class="sppb-addon-title sppb-feature-box-title sppb-media-heading">Bitcoin Transaction</h3>
                                          ...
                                          <div class="sppb-addon sppb-addon-feature sppb-text-left feature-style02">
                                            <div class="sppb-addon-content">
                                              <div class="sppb-media">
                                                <div class="pull-left">
                                                  <div class="sppb-icon">
                                                    <span class="sppb-icon-container"><i class="fa fa-mobile-phone"></i></span></div>
                                                  </div>
                                                  <div class="sppb-media-body">
                                                    <h3 class="sppb-addon-title sppb-feature-box-title sppb-media-heading">Mobile Apps</h3>
                                                    <div class="sppb-addon-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr diam nonumy eirmod tempor invidunt ut labore edolore.</div>
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div class="sppb-addon sppb-addon-feature sppb-text-left feature-style02">
                                              <div class="sppb-addon-content">
                                                <div class="sppb-media">
                                                  ...
                                                  <div class="sppb-media-body">
                                                    <h3 class="sppb-addon-title sppb-feature-box-title sppb-media-heading">Safe Wallet</h3>
                                                    <div class="sppb-addon-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr diam nonumy eirmod tempor invidunt ut labore edolore.</div>
                                                  </div>
                                                </div>
                                              </div>
